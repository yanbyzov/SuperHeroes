...
Marvel_Weapon::Marvel_Weapon()
{
	num_of_Weapon = 0;
}

void Marvel_Weapon::set_name()
{
	Exception ex;
...
void Marvel_Weapon::save(ofstream & fout)
{
	fout << num_of_Weapon << "%";
	for (int i = 0; i < num_of_Weapon; i++)
	{
...
void Marvel_Weapon::load(ifstream & fin)
{
...
Marvel_Weapon::~Marvel_Weapon()
{
	cout << "Destructor_~Marvel_Weapon" << endl;
	for (int i = 0; i < num_of_Weapon; ++i)
	{
		delete[] name[i];
	}
