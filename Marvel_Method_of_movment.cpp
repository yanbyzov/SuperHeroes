...
Marvel_Method_of_movment::Marvel_Method_of_movment()
{
	num_of_Methods = 0;
	cout << "Marvel_Method_of_movment" << endl;
}



void Marvel_Method_of_movment::set_name()
{
	Exception ex;
...
void Marvel_Method_of_movment::put()
{
	for (int i = 0; i < num_of_Methods; ++i)
	{
		puts(name[i]);
...
void Marvel_Method_of_movment::save(ofstream & fout)
{
	fout << num_of_Methods << "%";
	for (int i = 0; i < num_of_Methods; i++)
	{
...
void Marvel_Method_of_movment::load(ifstream & fin)
{
...
void Marvel_Method_of_movment::info()
{
	cout << "Marvel_Method_of_movment ====> ";
	for (int i = 0; i < num_of_Methods; ++i)
	{
		puts(name[i]);
	}
...
Marvel_Method_of_movment::~Marvel_Method_of_movment()
{
	cout << "Destructor_~Marvel_Method_of_movment" << endl;
	for (int i = 0; i < num_of_Methods; ++i)
	{
		delete[] name[i];
	}
